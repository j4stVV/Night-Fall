...
[CreateAssetMenu(fileName = "Wave Data", menuName ="Night Fall/Wave Data")]
public class WaveData : SpawnData
{
    ...
    {
        //Determines how many enemies to spawn
        int count = Random.Range(spawnsPerTick.x, spawnsPerTick.y);

       //If we have less than minimumEnemies on the screen, we will set the 
       //count to be equals to the number of enemies to spawn to populate the screen 
       //until it has minumumEnemies within
