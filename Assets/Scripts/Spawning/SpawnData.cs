...
public abstract class SpawnData : ScriptableObject
{
    ...
    //Return an array of prefabs that we should spawn
    //Take an optional parameter of how many enemies are on the screen at the moment
    public virtual GameObject[] GetSpawns(int totalEnemies = 0)
    {
        ...
        {
            //Randomly picks one of the possible spawns and insert it into the array
