...
[CreateAssetMenu(fileName = "Character Data", menuName = "Night Fall/Character Data")]
public class CharacterData : ScriptableObject
{
    ...
    [SerializeField]
    [TextArea] private string characterDescription;
    ...
    public struct Stats
    {
        ...
        {
            s1.maxHealth += s2.maxHealth * s1.maxHealth;
            ...
            s1.greed += s2.greed;
            s1.curse += s2.curse;
            s1.speed += s2.speed * s1.speed;
            s1.might += s2.might * s1.might;
            s1.magnet += s2.magnet * s1.magnet;
            return s1;
        }
    }
